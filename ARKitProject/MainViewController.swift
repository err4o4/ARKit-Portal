...
class MainViewController: UIViewController {
    ...
    @IBAction func buttonClicked(_ sender: Any) {
        ...
        if isRecording {
            ...
            recorder?.record()
            clickButton.setBackgroundImage(UIImage(named: "buttonringRed"), for: UIControl.State.normal)

        } else {
            print("Stop recording")
            recorder?.stopAndExport()
            clickButton.setBackgroundImage(UIImage(named: "buttonring"), for: UIControl.State.normal)
        }
